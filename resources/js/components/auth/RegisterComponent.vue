          ...
          <div class="login-content login-content-signup d-flex flex-column">
              ...
              <!--end::Aside Top-->
                ...
                <div class="login-form">
                    <!--begin::Form-->
                    <form class="form px-10" novalidate="novalidate" id="kt_login_signup_form" @submit.prevent="handleRegister">
                        <!--begin: Wizard Step 1-->
                        <div class=" " data-wizard-type="step-content" data-wizard-state="current">
                            ...
                            <div class="form-group">
                                ...
                                <input v-model="formData.email" type="email" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="email" placeholder="Email"/>
                            </div>
                            <!--end::Form Group-->
                            <!--begin::Form Group-->
                            <div class="row">
                        ...
                        <div class="pb-5" data-wizard-type="step-content">
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                        ...
                                        <div class="col-9 col-form-label">
                                            <div class="radio-inline">
                                                <label class="radio radio-primary">
                                                    <input v-model="formData.gender" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" type="radio" name="gender" checked="checked" value="male"/>
                                                    <span></span>
                                                    Male
                                                </label>
                                                <label class="radio radio-primary">
                                                    <input v-model="formData.gender" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" type="radio" name="gender" value="female"/>
                                                    <span></span>
                                                    Female
                                                </label>
                                            </div>
                                    ...
                                    <!-- <div class="form-group">
                                        <label class="font-size-h6 font-weight-bolder text-dark">Gender</label>
                                        <input v-model="gender" type="text" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="address1" placeholder="Address Line 1" value="Address Line 1" />
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input v-model="formData.address" type="text" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="address" placeholder="Address" value="Address" />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input v-model="formData.city" type="text" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="city" placeholder="City" />
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input v-model="formData.state" type="text" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="state" placeholder="State" />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input v-model="formData.zip" type="text" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="zip" placeholder="Zip" />
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select v-model="formData.country" name="country" class="form-control form-control-solid h-auto py-7 px-5 border-0 rounded-lg font-size-h6">
