...
<html lang="en" >
    ...
    <head><base href="">
                <meta charset="utf-8"/>
        <title>Affiliate Program | Dashboard</title>
        ...
        <link href="{{ asset('demo13/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css') }}" rel="stylesheet" type="text/css"/>
